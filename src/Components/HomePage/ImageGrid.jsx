    ...
    <div className="relative w-full h-[450px]">
      ...
      {/* <Spline
        ...
        style={{
          ...
          left: 0,
          right: 0,
          height: '100%', // Keep the Spline height full
        }}
      /> */}

      <div className="flex w-full h-full relative">
        {/* Left Side: Image Grid */}
        <div className="grid grid-cols-4 grid-rows-4 gap-0 w-1/2">
        ...
        <div className="flex items-center justify-center text-center p-4 w-1/2 z-10">
          <div>
            <h1 className="text-2xl font-bold mb-4 text-white">ABOUT IETE</h1>
            <p className="text-lg text-white">
              The Institution of Electronics and Telecommunication Engineers (IETE) is a professional
              organization that fosters the advancement of science and technology in electronics,
              telecommunications, and related fields. Our mission is to provide education, training,
              and support to aspiring engineers and professionals.
            </p>
          </div>
        </div>
      </div>
